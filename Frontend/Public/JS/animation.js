        ...
        function colorswitch() {
            ...
            candidateLabel.classList.add("bg-blue-500", "text-white", "shadow-md");
            ...
            recruiterLabel.classList.remove("bg-blue-500", "text-white", "shadow-md");
            } else {
            ...
            candidateLabel.classList.remove("bg-blue-500", "text-white", "shadow-md");

            submitbutton.classList.add("border-rose-800", "bg-rose-800");
            submitbutton.classList.remove("border-blue-500", "bg-blue-500");
            }
        }
